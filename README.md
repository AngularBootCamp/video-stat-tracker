# Angular Boot Camp example: video-stat-tracker
...
**[StackBlitz for video-stat-tracker](https://stackblitz.io/github/AngularBootCamp/video-stat-tracker)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/video-stat-tracker.git
cd video-stat-tracker
npm install
npm start
```
